...
## 5. 🤖 AI 模型与推理 AI Models & Inference
...
## 10. 🏢 办公与协作 Productivity & Workspace
...
这 30 个 Skill 全部可以本地执行、零 API 依赖、即装即用。
