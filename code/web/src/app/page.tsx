        ...
        <section className="relative flex flex-col lg:flex-row gap-12 mb-20 pt-6">
          ...
          <AnimateIn delay={0.15} className="relative z-10 lg:w-1/3">
            <div className="glass rounded-xl p-5 font-mono text-[13px]">
              ...
              <pre className="text-text-dim leading-[1.7] overflow-x-auto whitespace-pre-wrap break-all text-[12px]">
                <code>
{`$ curl -fsSL https://catbus.xyz/install.sh \\
    | bash -s -- \\
    --bindcode <your-code> \\
    --relay wss://relay.catbus.xyz`}
                </code>
              </pre>
